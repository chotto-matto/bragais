...
<head>
  ...
  <title>Bragais Office - Log In</title>
    ...
    <div>
      <form action="php/actions/login.php" method="post">
        <div class="form-group">
            <div style="color:white; background-color:#a85db8; font-size:40px; border-radius:15px; height:60px; margin-top:-70px; padding-top:10px;">Log In</div><br><br>
          <label><span class="fas fa-user-alt" style="color:#a131b8; font-size:30px; margin-right:20px;"></span></span></span></label>
          <input type="text" name="employeeID" class="form-control" placeholder="Employee ID">
        </div>
        <div class="form-group">
          <label><span class="fas fa-key" style="color:#a131b8; font-size:30px; margin-right:20px;"></span></span></span> </label>
          <input type="password" name="password" id="pwInput" placeholder="Password">
        </div>
        <div class="form-group">
          <button type="submit" name="submit" id="submit">Log In</button> <br> <br>
